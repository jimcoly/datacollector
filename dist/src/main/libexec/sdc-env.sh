...
#
export SDC_JAVA_OPTS="-Xmx1024m -Xms1024m -server -XX:-OmitStackTraceInFastThrow ${SDC_JAVA_OPTS}  -agentlib:jdwp=transport=dt_socket,address=localhost:5005,server=y,suspend=n "
